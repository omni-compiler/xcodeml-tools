...
typedef struct HashTable {
    ...
    int keyType;     /* Type of keys used in this table.
                      ...
                      */
    HashEntry *(*findProc)(struct HashTable *tablePtr, const void *key);
    HashEntry *(*createProc)(struct HashTable *tablePtr, const void *key,
                             int *newPtr);
} HashTable;
...
#define FindHashEntry(tablePtr, key) (*((tablePtr)->findProc))(tablePtr, key)
#define CreateHashEntry(tablePtr, key, newPtr)                                 \
    (*((tablePtr)->createProc))(tablePtr, key, newPtr)

extern void DeleteHashEntry(HashEntry *entryPtr);
extern void DeleteHashTable(HashTable *tablePtr);
extern HashEntry *FirstHashEntry(HashTable *tablePtr, HashSearch *searchPtr);
extern char *HashStats(HashTable *tablePtr);
extern void InitHashTable(HashTable *tablePtr, int keyType);
extern HashEntry *NextHashEntry(HashSearch *searchPtr);
