...
xmp_loop_opt1:
        ...
        | XMPKW_MARGIN '(' xmp_expand_width_list ')'
	{ $$=list3(LIST, GEN_NODE(INT_CONSTANT, XMP_LOOP_MARGIN), $3, NULL); }
        | XMPKW_MARGIN '(' xmp_expand_width_list ')' '(' xmp_expand_width_list ')'
	{ $$=list3(LIST, GEN_NODE(INT_CONSTANT, XMP_LOOP_MARGIN), $3, $6); }
