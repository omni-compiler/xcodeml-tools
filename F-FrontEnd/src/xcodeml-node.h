...
#define XCODEML_IS_TERMINAL(x)                                                 \
    ((XCODEML_TYPE(x) == XcodeML_Value) ? true : false)
...
#define XCODEML_ARG3(x)                                                        \
    XCODEML_LIST_NODE(XCODEML_LIST_NEXT(XCODEML_LIST_NEXT(XMODEML_LIST(x))))
...
extern XcodeMLNode *xcodeml_CreateList2(XcodeMLNodeTypeT t, XcodeMLNode *x1,
                                        XcodeMLNode *x2);
extern XcodeMLNode *xcodeml_CreateList3(XcodeMLNodeTypeT t, XcodeMLNode *x1,
                                        XcodeMLNode *x2, XcodeMLNode *x3);
extern XcodeMLNode *xcodeml_AppendNode(XcodeMLNode *xlPtr, XcodeMLNode *x);
